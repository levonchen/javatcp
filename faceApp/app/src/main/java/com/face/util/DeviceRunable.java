...
public class DeviceRunable  extends Thread{
    ...
    public void run()
    {
        try {
            ...
            String string = SimplePreference.getPreference(parentActivity).getString(SpConstant.SP_DEVICES_ID, readDeviceID);
            ...
            //左后再次更新app 的缓存
            SimplePreference.getPreference(parentActivity).saveString(SpConstant.SP_DEVICES_ID, readDeviceID);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
